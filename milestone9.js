...
<body>
    <p><mark style="background-color:green">TOPIC:FUNCTIONS</mark></p>
    <script>
    ...
    <p><mark style="background-color:red">TOPIC:INDEXED COLLECTION</mark></p>
    <p><mark style="background-color:pink">FOR EACH ITERATOR</mark></p>
    <p id="demo"></p>
    <p><mark style="background-color:blue">FOR ITERATOR</mark></p>
    <p id="demo1"></p>
    <script>
    ...
    <p><mark style="background-color:yellow">TOPIC:JSON</mark></p>
    <script>
